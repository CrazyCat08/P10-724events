...
const Page = () => {
  ...
  const { data } = useData();
  // On récupère la prestation la plus récente
  const last = data?.events.reduce((latestEvt, currentEvt) => {
    const latestDate = new Date(latestEvt.date);
    const currentDate = new Date(currentEvt.date);
    return currentDate > latestDate ? currentEvt : latestEvt;
  });
  ...
  return <>
    ...
    <main>
      ...
      {/* Ajout de l'id nos-services à la section suivante */}
      ...
      {/* Ajout de l'id nos-realisations dans la section suivante */}
      <section id="nos-realisations" className="EventsContainer">
        <h2 className="Title">Nos réalisations</h2>
        <EventList />
      </section>
      {/* <section className="PeoplesContainer"> */}
      {/* Ajout de l'id notre-equipe dans la section suivante */}
    ...
    <footer className="row">
      <div className="col presta">
        ...
        <EventCard
          ...
          small
          label={last?.type} // remplace label="boom"
        />
      </div>
